...
test('long-shot awards use actual distance above 100m and Dead Eye above 500m', () => {
  ...
  assert.deepEqual(longShotAwardForDistance(101.25), {
    key: 'longShot100', title: '101M LONG SHOT', subtitle: 'LONG RANGE PRECISION', color: '#8ef7a8',
  });
  assert.deepEqual(longShotAwardForDistance(249.99), {
    key: 'longShot100', title: '249M LONG SHOT', subtitle: 'LONG RANGE PRECISION', color: '#8ef7a8',
  });
  assert.deepEqual(longShotAwardForDistance(500), {
    key: 'longShot100', title: '500M LONG SHOT', subtitle: 'LONG RANGE PRECISION', color: '#8ef7a8',
  });
